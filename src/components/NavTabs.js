    ...
    if (this.props.getToken()) {
      return (
        <React.Fragment>
          ...
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/addhouse"}>
              Add House
            </Button>
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            <Button href="/" onClick={this.onLogoutclicked}>
              Logout
            </Button>
          </ListItem>
        </React.Fragment>
      ...
      return (
        <React.Fragment>
          ...
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/login"}>Login</Button>
          </ListItem>
        </React.Fragment>
      );
    }
        ...
        >
          <div>
            <div style={{ display: "flex" }}>
              {this.props.isAdmin() && <AdminDrawer />}
              <h3 style={{ fontSize: "30px", margin: 0, color: "black" }}>
                <a className={classes.LogoTextNavbar} href={"/"}>
                  <span style={{ color: "#ee662d" }}>A</span>genagn
                </a>
              </h3>
            </div>
