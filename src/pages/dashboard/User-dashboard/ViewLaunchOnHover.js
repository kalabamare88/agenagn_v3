      ...
      <Grid container>
        <Grid item md={12} className={classes.card}>
          <Card className={classes.listCard} key={this.props.row._id}>
            <CardContent
              classNmae={classes.listCardContent}
              ...
              <Grid container>
                <Grid item xs={1} style={{}}>
                  <Avatar
                    ...
                    src={
                      "/images/products/" +
                      this.props.row.encodedAvatarUrl +
                      ".jpg"
                    }
                ...
                <Grid
                  ...
                  md={6}
                  lg={7}
                  className={classes.centerPartCard}
                >
                  <Box align={"left"} className={classes.listCardTitle}>
                    <Typography variant="h6">
                      ...
                      >
                        &nbsp; &nbsp; by {this.props.row.ownerName} :{" "}
                        {this.props.row.productNetwork}
                      </Typography>
                    </Typography>
                  </Box>
                  ...
                  <Typography
                    ...
                    color="textSecondary"
                    align={"left"}
                    className={classes.listCardFooter}
                  >
                    Singapore | {this.props.row.productCategory}
                  </Typography>
                </Grid>
                  ...
                  <Box className={classes.listCardLeft}>
                    <Grid container>
                      <Grid item xs={6} md={12}>
                        <Typography
                          className={classes.textProductCommission}
                          variant=""
                        >
                          {this.props.row.productCommission}% of $
                          {this.props.row.productPrice}
                        </Typography>

                        <Typography
                          variant=""
                          className={classes.commissionValueText}
                        >
                          Commission Value
                        </Typography>
                      </Grid>
                      ...
                      <Grid item xs={6} md={12}>
                        <Button
                          href={"http://" + this.props.row.jvPageLink}
                          target="_blank"
